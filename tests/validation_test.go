...
import (
	...
	testExclusiveMaximum "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/exclusiveMaximum"
	testExclusiveMinimum "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/exclusiveMinimum"
	testMaxLength "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/maxLength"
	testMaximum "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/maximum"
	testMinLength "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/minLength"
	testMinimum "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/minimum"
	testMultipleOf "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/multipleOf"
	testPattern "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/pattern"
	testPrimitiveDefs "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/primitive_defs"
	testReadOnlyFields "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/readOnly"
	testReadOnlyAndRequiredFields "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/readOnlyAndRequired"
	testRequiredFields "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validation/requiredFields"
	testReadOnlyValidationDisabledFields "github.com/CognexVisionSoftware/go-jsonschema/tests/data/validationDisabled/readOnly"
	"github.com/CognexVisionSoftware/go-jsonschema/tests/helpers"
)
