...
func (p *File) Generate(out *Emitter) error {
	out.Comment("Code generated by github.com/CognexVisionSoftware/go-jsonschema, DO NOT EDIT.")
	out.Newline()
...
func (td *TypeDecl) TypeContainsNumberOrInterface() bool {
	return typeContainsNumberOrInterface(td.Type, map[*TypeDecl]struct{}{})
}

func typeContainsNumberOrInterface(t Type, visited map[*TypeDecl]struct{}) bool {
	switch t := t.(type) {
	case JsonNumberType:
		return true
	...
	case *StructType:
		for _, f := range t.Fields {
			if typeContainsNumberOrInterface(f.Type, visited) {
				return true
			}
		}
	...
	case NamedType:
		...
		if _, ok := visited[t.Decl]; ok {
			return false
		}
		visited[t.Decl] = struct{}{}

		return typeContainsNumberOrInterface(t.Decl.Type, visited)
	case *NamedType:
		if t == nil || t.Decl == nil {
			return false
		}
		...
		return typeContainsNumberOrInterface(t.Decl.Type, visited)
	case PointerType:
		return typeContainsNumberOrInterface(t.Type, visited)
	case *PointerType:
		return typeContainsNumberOrInterface(t.Type, visited)
	case ArrayType:
		return typeContainsNumberOrInterface(t.Type, visited)
	case *ArrayType:
		return typeContainsNumberOrInterface(t.Type, visited)
	case MapType:
		return typeContainsNumberOrInterface(t.ValueType, visited)
	case *MapType:
		return typeContainsNumberOrInterface(t.ValueType, visited)
	default:
		return false
